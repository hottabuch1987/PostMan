        ...
        <div class="main-center col-span-2 space-y-4">
            ...
            >
                <form v-on:submit.prevent="submitForm" method="post">
                    <div class="p-4">  
                        <textarea v-model="body" class="p-4 w-full bg-gray-100 rounded-lg" placeholder="О чем ты думаешь?"></textarea>
...
export default {
    ...
    mounted() {
        ...
        document.title = "Мой профиль | Почтальон"
            ...
            axios
                ...
                .then(response => {
                    ...
                    if (response.data.message == 'request already sent') {
                        this.toastStore.showToast(5000, 'Запрос уже отправлен!', 'bg-red-300')
                    } else {
                        this.toastStore.showToast(5000, 'Запрос отправлен!', 'bg-emerald-300')
                    }
                })
                .catch(error => {
                    console.log('error', error)
