  ...
  <div class="mx-6 py-10 text-center md:text-left">
    <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
      ...
      <div class="">
        ...
        <p class="mb-4">
          <router-link to="/" class="text-neutral-600 dark:text-neutral-200"
            >Главная</router-link
          >
        </p>
        <p class="mb-4">
          <router-link to="/search" class="text-neutral-600 dark:text-neutral-200"
            >Поиск</router-link
          >
        </p>
