    ...
    <div>
        ...
        <div class="my-6 flex justify-between">
            <div class="flex space-x-6">
                <button class="flex items-center space-x-2" @click="likePost(post.id)">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <RouterLink :to="{name: 'postview', params: {id: post.id}}" class="text-gray-500 text-xs">{{ post.comments_count }} коментариев</RouterLink>
                </div>
            </div>
    ...
    <div v-if="showExtraModal">
        <div class="flex space-x-6 items-center">
            ...
            >
                ...
                <span class="text-orange-500 text-xs">Пожаловаться на публикацию</span>
            </div>
        </div>
    </div>
</div>
        ...
        reportPost() {
            axios
                ...
                .then(response => {
                    ...
                    this.toastStore.showToast(5000, 'Сообщение было сообщено', 'bg-emerald-500')
                })
                .catch(error => {
                    console.log("error", error);
                })
        ...
        deletePost() {
            ...
            axios
                ...
                .then(response => {
                    ...
                    this.toastStore.showToast(5000, 'Пост был удален!', 'bg-emerald-500')
                })
                .catch(error => {
                    console.log("error", error);
                })
