    ...
    <nav class="py-10 px-8 border-b border-gray-200">
        <div class="max-w-7xl mx-auto">
            <div class="flex items-center justify-between">
                <div class="menu-left">
                    <router-link to="/" class="text-xl font-normal hover:font-bold rounded-lg text-white">Почтальон
                    </router-link>
                </div>
                ...
                <div class="menu-right">
                    ...
                    <template v-else>
                        <RouterLink to="/login" class="mr-4 py-4 px-6 bg-gray-600 text-white rounded-lg">Войти</RouterLink>
                        <RouterLink to="/signup" class="py-4 px-6 bg-purple-600 text-white rounded-lg">Регистрация</RouterLink>
